<template>
    <div class="MiddleMain" ref="dataMap" id="china">
...
export default {
    ...
    mounted() {
        ...
        for(let i=0;i<this.aqidata.length;i++){
            axios({
                method: 'post',
                url: 'https://apis.tianapi.com/aqi/index',
                params:{
                    key: 'efd2ef207db9ab5aea07c484a8fae2ce',
                    area: this.aqidata[i].name,
                },
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
            }).then(res => {
                this.aqidata[i].value=res.data.result.aqi;
            })
        }
